...
fdoc_Hinf_scatter_style = {'k+','LineWidth',2};
...
set(gca,'FontSize',15);
scatter(p_MC(:,1), p_MC(:,2), fdoc_Hinf_scatter_style{:});
...
P_Hinf       = feedbackHinf.phase.state(7:10);
...
for ii = 1 : num_MC
    ...
    % Propagate dynamics 
    [tout_FDOC_Hinf, xout_FDOC_Hinf] = ode45(@(t,x) ZermeloFeedbackDynamics_v2(t,x,feedbackHinf,C,p_ii), tspan, x0, options); 
    [tout_FDOC_LQR, xout_FDOC_LQR]   = ode45(@(t,x) ZermeloFeedbackDynamics_v2(t,x,feedbackLQR,C,p_ii), tspan, x0, options);
