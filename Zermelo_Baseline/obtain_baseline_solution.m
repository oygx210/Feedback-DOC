function sol = obtain_baseline_solution(C, IC, FC, LB, UB)
...
%-------------------------------------------------------------------%
setup.name                           = 'Zermelo-baseline-Problem';
setup.functions.continuous           = @Zermelo_baseline_Continuous;
setup.functions.endpoint             = @Zermelo_baseline_Endpoint;
