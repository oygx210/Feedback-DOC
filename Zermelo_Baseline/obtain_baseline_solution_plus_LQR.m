function sol = obtain_baseline_solution_plus_LQR(C, IC, FC, LB, UB)
...
setup.functions.continuous           = @Zermelo_LQR_Continuous;
setup.functions.endpoint             = @Zermelo_LQR_Endpoint;
