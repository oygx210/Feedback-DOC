function sol = obtain_baseline_solution_v2(C, IC, FC, LB, UB)
...
%-------------------------------------------------------------------%
setup.name                           = 'Zermelo-baseline-Problem-v2';
setup.functions.continuous           = @Zermelo_baseline_Continuous_v2;
setup.functions.endpoint             = @Zermelo_baseline_Endpoint_v2;
